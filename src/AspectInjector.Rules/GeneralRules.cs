...
namespace AspectInjector.Rules
{
    ...
    {
        internal static DiagnosticDescriptor Make(string id, string title, string message, string description, DiagnosticSeverity severity = DiagnosticSeverity.Error)
        ...
        public static readonly DiagnosticDescriptor CompilationMustSecceedIfNoOtherErrors =
            Make("AI_ERR0",
        ...
        public static readonly DiagnosticDescriptor UnknownCompilationOption =
            Make("AI_ERR1",
        ...
        public static readonly DiagnosticDescriptor UnexpectedCompilerBehaviour =
            Make("AI_ERR2",
