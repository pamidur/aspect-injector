...
using AspectInjector.Broker;
    ...
    namespace TestNameSpace
    {
        ...
        class DummyClass{}
            ...
            var expected = new DiagnosticResult
            {
                Id = Rules.AspectShouldImplementMixin.Id,
                Message = string.Format((string)Rules.AspectShouldImplementMixin.MessageFormat, "TypeClass", "IDummyInterface"),
                Severity = DiagnosticSeverity.Error,
                Locations =
                    new[] {
                            new DiagnosticResultLocation("Test0.cs", 12, 10)
...
using AspectInjector.Broker;
    ...
    namespace TestNameSpace
    {
        ...
        class DummyClass{}
            ...
            {
                Id = Rules.AspectShouldImplementMixin.Id,
                Message = string.Format((string)Rules.AspectShouldImplementMixin.MessageFormat, "TypeClass", "IDummyInterface2"),
                Severity = DiagnosticSeverity.Error,
                Locations =
                    new[] {
...
using AspectInjector.Broker;
    ...
    namespace TestNameSpace
    {
        ...
        class DummyClass{}
            ...
            var expected = new DiagnosticResult
            {
                Id = Rules.MixinShouldBePartOfAspect.Id,
                Message = string.Format((string)Rules.MixinShouldBePartOfAspect.MessageFormat, "TypeClass"),
                Severity = DiagnosticSeverity.Error,
                Locations =
                    new[] {
                            new DiagnosticResultLocation("Test0.cs", 12, 10)
